...
class Agent:
    ...
    # Act based upon epsilon.
    # If random number is smaller than epsilon
    # make an explore move, otherwise make an
    # exploit move
    def act(self, state):
    ...
    # Add data to memory. Data in memory is used
    # to train the model.
    ...
    def replay(self, batch_size, score, epsilon):
        ...
        if memory_size > batch_size:
            ...
            if self.decay_epsilon == True:
                # Uncomment to use the epsilon_decay rate
